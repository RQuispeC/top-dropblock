...
class ImageTripletSoftmaxDropbatchFGnetEngine(engine.Engine):
    ...
    def __init__(self, datamanager, model, optimizer, margin=0.3,
                 weight_t=1, weight_x=1, weight_x_parts=1, weight_db_t=1, weight_db_x=1, scheduler=None, use_gpu=True,
                 label_smooth=True):
        super(ImageTripletSoftmaxDropbatchFGnetEngine, self).__init__(datamanager, model, optimizer, scheduler, use_gpu)
    ...
    def train(self, epoch, max_epoch, trainloader, fixbase_epoch=0, open_layers=None, print_freq=10):
        ...
        for batch_idx, data in enumerate(trainloader):
            ...
            global_outputs, parts_output, features, part_weights, (db_prelogits, db_features) = self.model(imgs)
            ...
            loss = self.weight_t * loss_t + self.weight_x * loss_x + self.weight_x_parts * loss_x_parts + self.weight_db_t * loss_db_t + self.weight_db_x * loss_db_x
