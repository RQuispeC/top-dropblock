...
def get_default_config():
    ...
    cfg.loss.triplet.weight_r =1. # weight to balance reference loss
    cfg.loss.triplet.weight_n = 1. # weight to balance cross entropy loss
    cfg.loss.triplet.weight_g = 1. # weight to balance group loss
    cfg.loss.triplet.weight_dep = 1. # weight to balance triplet with depency loss 
    ...
    cfg.loss.triplet.weight_r_parts = 1. # weight to balance reference loss
    cfg.loss.triplet.weight_g_parts = 1. # weight to balance group loss
    cfg.loss.dropbatch = CN()
    cfg.loss.dropbatch.weight_db_t = 1. # weight to balance triplet loss in dropbatch stream
    cfg.loss.dropbatch.weight_db_r = 1. # weight to balance reference loss in dropbatch stream
    cfg.loss.dropbatch.weight_db_x = 1. # weight to balance cross entropy loss in dropbatch stream
    cfg.loss.dropbatch.weight_db_g = 1. # weight to balance group loss in dropbatch stream
    cfg.loss.dropbatch.weight_b_db_t = 1. # weight to balance triplet loss in dropbatch stream after bootleneck
    cfg.loss.dropbatch.weight_b_db_r = 1. # weight to balance reference loss in dropbatch stream after bootleneck
    cfg.loss.dropbatch.weight_b_db_x = 1. # weight to balance cross entropy loss in dropbatch stream after bootleneck
    cfg.loss.dropbatch.weight_b_db_g = 1. # weight to balance group loss in dropbatch stream after bootleneck
    ...
    cfg.loss.focal = CN()
    cfg.loss.focal.weight_f=1.
    cfg.loss.focal.weight_db_f=1.
    cfg.loss.focal.weight_b_db_f=1.
    cfg.loss.pose = CN()
    cfg.loss.pose.weight_mse=1.
    cfg.loss.pose.weight_db_mse=1.
    cfg.loss.pose.weight_b_db_mse=1.
    cfg.loss.focal.gamma=2.
    cfg.loss.cluster = CN()
    cfg.loss.cluster.weight_c=1.
    cfg.loss.cluster.weight_db_c=1.
    cfg.loss.cluster.weight_b_db_c=1.
